...
Route::post('/challenge/{challenge}/start', [ChallengeController::class, 'start'])
    ->name('challenge.start')
    ->middleware('auth');
Route::get('/challenge/{challenge}/progress', [ChallengeController::class, 'progress'])
    ->name('challenge.progress')
    ->middleware('auth');
Route::post('/challenge/{challenge}/task/{task}/complete', [ChallengeController::class, 'completeTask'])
    ->name('task.complete')
    ->middleware('auth');
...
Route::middleware(['auth', 'admin'])->group(function () {
    ...
    // Route reset toàn bộ tiến độ
    Route::post('/admin/reset-all-progress', [ChallengeController::class, 'resetAllProgress'])->name('admin.reset_progress');
});
